 ...
 */
public class CoverStyleActivity extends Activity implements XListView.IXListViewListener{

    private boolean hasTime;   //资讯详情页（网页）是否显示时间
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_coverstyle);
        initView();
        initOther();
        getNetStateAndData();
        TotalListener();
    ...
    private void initOther() {
        mContext = CoverStyleActivity.this;
        Intent intent = this.getIntent();
        hasTime = intent.getBooleanExtra("hasTime",true);
        Log.e("hasTime","CoverStyleActivity    hasTime:  "+hasTime);
    ...
    private void initView() {
        coverStyleLv = (XListView) findViewById(R.id.coverStyleLv);
        coverStylePb = (ProgressBar) findViewById(R.id.coverStylePb);
        coverstyle_title=(CiistTitleView)findViewById(R.id.coverstyle_titleview);
    ...
    private void getListData() {
        String _url = ServerInfo.GetInfoPre + mSubjectCode + "/" + index + "/15";
