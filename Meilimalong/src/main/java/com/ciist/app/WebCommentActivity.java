...
public class WebCommentActivity extends AppCompatActivity {
    ...
    private EditText web2_neirong_edi;
...
//                    loading.dismiss();
                    ...
                    break;
                case MSG_FAILURE:
                    Toast.makeText(WebCommentActivity.this, "亲，获取数据失败了，请检查您的网络", Toast.LENGTH_SHORT).show();
//                    loading.dismiss();
                    if (waiting != null) {
                        waiting.setVisibility(View.GONE);
                    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        web2_name_edi = (EditText) findViewById(R.id.web_comment_name_edi);
        web2_phonenumber_edi = (EditText) findViewById(R.id.web_comment_phonenumber_edi);
        web2_neirong_edi = (EditText) findViewById(R.id.web_comment_neirong_edi);


        web2_up_title = (CiistTitleView) findViewById(R.id.web_comment_up_titleview);
        ...
        web2_down_title = (Button) findViewById(R.id.web_comment_down_button);
...
//                web2_name_edi.getText().toString().equals(web2_phonenumber_edi.getText().toString().equals( web2_IDnumber_edi.getText().toString().equals(web2_gridview!=null)))
                if (web2_name_edi.length()==0&&web2_phonenumber_edi.length()==0&&web2_neirong_edi.length()==0){
                    Toast.makeText(WebCommentActivity.this,"请输入信息",Toast.LENGTH_LONG).show();

                }else if(web2_name_edi.length()!=0&&web2_phonenumber_edi.length()!=0&&web2_neirong_edi.length()!=0){
                    startActivity(new Intent(WebCommentActivity.this, ServiceActivity.class));
                }else if(web2_name_edi.length()!=0&&web2_neirong_edi.length()!=0&&web2_phonenumber_edi.length()!=11){
                    Toast.makeText(WebCommentActivity.this,"请输入11位手机号码",Toast.LENGTH_LONG).show();
                }else if(web2_name_edi.length()==0&&web2_neirong_edi.length()!=0&&web2_phonenumber_edi.length()==11){
                    Toast.makeText(WebCommentActivity.this,"请输入姓名",Toast.LENGTH_LONG).show();
                }else if(web2_name_edi.length()!=0&&web2_neirong_edi.length()==0&&web2_phonenumber_edi.length()==11){
                    Toast.makeText(WebCommentActivity.this,"请输入意见内容",Toast.LENGTH_LONG).show();
                }

            }
        });
        web2_scr = (ScrollView) findViewById(R.id.web_comment_scr);
        web2_lin = (LinearLayout) findViewById(R.id.web_comment_lin);
        web2_all_lin = (LinearLayout) findViewById(R.id.web_comment_all_lin);
        Button web2_shangchuan = (Button) findViewById(R.id.web_comment_button);
        web2_shangchuan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showPicturePicker(WebCommentActivity.this);
            }
        });
        Button web2_button = (Button) findViewById(R.id.web_comment_button);
        ...
        web2_name_txt = (TextView) findViewById(R.id.web_comment_txt);
        web2_name_txt.setText(intent.getStringExtra("subjecttitle"));


        waiting = (ProgressBar) findViewById(R.id.web_comment_waitloading);
        webview = (WebView) findViewById(R.id.web_comment_webView);
        Intent i = getIntent();
