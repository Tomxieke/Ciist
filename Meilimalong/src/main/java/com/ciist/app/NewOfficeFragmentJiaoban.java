 ...
 */
public class NewOfficeFragmentJiaoban extends android.support.v4.app.Fragment {
    ...
    public NewOfficeFragmentJiaoban() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mInflater = inflater;
        mAction = "jb";
        mView = inflater.inflate(R.layout.new_office_fragment_jiaoban, container, false);
        initInputParams();
        initCtrls();
        registerListening();
        LoadDatas();
...
//            fragment1.setArguments(data);//通过Bundle向Activity中传递值
            ...
            mTitle = data.getString("title", "交办工作");
    ...
    void initCtrls() {
        try {
            ...
            mlistView = (SwipeListView) mView.findViewById(R.id.newofficejiaobanlist);
            mlistView.setOffsetLeft(screenWidth-dp2px(context,60));

            waiting = (ProgressBar) mView.findViewById(R.id.waitloading);
            mBtnCreateTask = (Button) mView.findViewById(R.id.btnNewofficeCreateTask);
            mBtnCreateTask.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent tmpIntent = new Intent(context, IndexOfOACreateNewTaskActivity.class);
...
//                        mlistView.removeFooterView(footer);
                ...
                case MSG_NODATA:
                    mlistView.removeFooterView(footer);
                    Toast.makeText(context, "亲,您还没交办任何，开始使用吧!", Toast.LENGTH_SHORT).show();
                    if (waiting != null) {
                        waiting.setVisibility(View.GONE);
                    }
                    break;
                case MSG_CHART:
                    ...
                    ChartHelper.showPieChart(mChart, mPieData, "交办工作");
                    break;
            }
        }
    };
...
//                http get end
    ...
    private class InternetOfChartThread extends Thread {
        ...
        public void run() {
            ...
            String _url = "";
            try {
                _url = ServerInfo.ServerBKRoot + "/task/TaskJiaobanOutline/ciistkey/" + mIdentify;
                HttpClient client = new DefaultHttpClient();
                HttpGet get = new HttpGet(_url);
                JSONObject json = null;
                try {
...
//        float quarterly4 = 38;
                    ...
                    yValues.add(new Entry(quarterly_weihuibao, 3));
                    yValues.add(new Entry(quarterly_cuiban, 4));
                    yValues.add(new Entry(quarterly_xinhuibao, 5));
//        yValues.add(new Entry(quarterly4, 3));
                    ...
                    colors.add(Color.rgb(205, 188, 205));
                    colors.add(Color.rgb(114, 123, 223));
    ...
    void createChart() {
        ...
        mChart = (PieChart) mView.findViewById(R.id.newOfficePieChartJiaoban);
//        mChart = (BarChart) mView.findViewById(R.id.newOfficeBarChartJiaoban);
