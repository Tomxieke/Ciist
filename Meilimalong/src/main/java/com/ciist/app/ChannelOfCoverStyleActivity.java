...
public class ChannelOfCoverStyleActivity extends AppCompatActivity {
...
//                        adapter = new CiistAdapter2(context,data);
...
//        mLocationClient.unRegisterLocationListener(MyLocationListener);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.channel_of_cover_style_activity);
        mcontext = getApplicationContext();

        waiting = (ProgressBar) findViewById(R.id.waitloading);
        chan_title=(CiistTitleView)findViewById(R.id.channel_titleview);
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                try {
                    ...
                    if (subjectLink == null || subjectLink == "" || subjectLink.length() < 1) {
                        ...
                        tmpIntent.putExtra("img_url",tmpobj.getImgsrc());
                        ...
                        if (linkType != null && linkType == "ciist1") {
                            ...
                            Intent tmpIntent = new Intent(ChannelOfCoverStyleActivity.this, ChannelOfCoverStyleActivity.class);
